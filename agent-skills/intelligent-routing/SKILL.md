...
| **Cloud/K8s**       | "docker", "k8s", "kubernetes", "cloud", "aws" | `cloud-native-expert`                    | ✅ YES       |
| **Data Science**    | "pandas", "ml", "data", "visualization"    | `data-science-agent`                        | ✅ YES       |
| **AI Research**     | "prompt", "llm", "logic", "research"       | `ai-researcher`                             | ✅ YES       |
| **Business/Audit**  | "strategy", "roadmap", "blueprint", "audit"| `business-architect`                        | ✅ YES       |
| **Knowledge/RAG**   | "knowledge", "wiki", "synthesis", "docs"   | `knowledge-expert`                          | ✅ YES       |
| **Platform/Core**   | "antigravity", "agent core", "system admin"| `antigravity-platform-expert`               | ✅ YES       |
| **Quality/Gate**    | "perfection", "ceo", "coo", "quality"      | `agent-perfectionist`                       | ✅ YES       |
...
## 4. Response Format & Telemetry

**When auto-selecting an agent, inform the user concisely AND emit a routing span:**
...
### 🧠 Agent Lightning Integration (Internal)

**System must emit the following telemetry for every routing decision:**

```python
from agentlightning.emitter import emit_span, emit_reward

# Trace the decision
emit_span("routing.decision", {
    "intent": "authentication",
    "selected_agents": ["security-auditor", "backend-specialist"],
    "confidence": 0.95,
    "complexity": "MODERATE"
})

# Reward logic (Post-response)
# If user accepts/continues -> emit_reward(1.0)
# If user corrects/stops -> emit_reward(0.0)
```
...
- ✅ **Self-Optimizing**: System learns which agents perform best for specific tasks
...
| **Cloud**       | docker, k8s, kubernetes, aws, terraform    | `cloud-native-expert`   |
| **Data Science**| pandas, ml, polars, visualization          | `data-science-agent`    |
| **AI Research** | prompt, llm, logic, researcher             | `ai-researcher`         |
| **Business**    | strategy, solution, blueprint, feasibility | `business-architect`    |
| **Knowledge**   | research, synthesis, scholar, wiki         | `knowledge-expert`      |
| **Antigravity** | platform, core, rules, admin               | `antigravity-platform-expert` |
| **Quality**     | perfection, quality, ceo, coo, audit       | `agent-perfectionist`   |
