...
CORE_CHECKS = [
    ...
    ("Advanced Security", ".agent/skills/advanced-security-audit/scripts/deep_scan.py", False),
    ("Vibe-Check TDD", ".agent/skills/vibe-check-tdd/scripts/tdd_logger.py", False),
]
