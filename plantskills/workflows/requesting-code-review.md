...
1. **Analyze Request**
   - Understand the user's specific need regarding **requesting-code-review**.
   - Identify if the task involves requesting-code-review best practices, specific patterns, or tool usage.

2. **Activate Skill**
   - Use the `view_file` tool to read the full instructions in:
     `E:\ABHINAV\AI KIT\.agent\skills\requesting-code-review\SKILL.md`
