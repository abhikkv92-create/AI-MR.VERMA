---
description: VR/AR development principles. Comfort, interaction, performance requirements. allowed-tools: Read, Write, Edit, Glob, Grep
---

# vr-ar Workflow

1. **Analyze Request**
   - Understand the user's specific need regarding **vr-ar**.
   - Identify if the task involves vr-ar best practices, specific patterns, or tool usage.

2. **Activate Skill**
   - Use the `view_file` tool to read the full instructions in:
     `E:\ABHINAV\AI KIT\.agent\skills\vr-ar\SKILL.md`
