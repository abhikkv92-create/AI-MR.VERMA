---
description: Web application testing principles. E2E, Playwright, deep audit strategies. allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# webapp-testing Workflow

1. **Analyze Request**
   - Understand the user's specific need regarding **webapp-testing**.
   - Identify if the task involves webapp-testing best practices, specific patterns, or tool usage.

2. **Activate Skill**
   - Use the `view_file` tool to read the full instructions in:
     `E:\ABHINAV\AI KIT\.agent\skills\webapp-testing\SKILL.md`
