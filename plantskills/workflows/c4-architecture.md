...
# c4-architecture Workflow

1. **Analyze Request**
   - Understand the user's specific need regarding **c4-architecture**.
   - Identify if the task involves c4-architecture best practices, specific patterns, or tool usage.

2. **Activate Skill**
   - Use the `view_file` tool to read the full instructions in:
     `E:\ABHINAV\AI KIT\.agent\skills\c4-architecture\SKILL.md`
