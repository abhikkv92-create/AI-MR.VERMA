...
1. **Analyze Request**
   - Understand the user's specific need regarding **using-git-worktrees**.
   - Identify if the task involves using-git-worktrees best practices, specific patterns, or tool usage.

2. **Activate Skill**
   - Use the `view_file` tool to read the full instructions in:
     `E:\ABHINAV\AI KIT\.agent\skills\using-git-worktrees\SKILL.md`
