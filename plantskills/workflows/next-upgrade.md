---
description: Upgrade Next.js to the latest version following official migration guides and codemods argument-hint: \"[target-version]\"
---

# next-upgrade Workflow

1. **Analyze Request**
   - Understand the user's specific need regarding **next-upgrade**.
   - Identify if the task involves next-upgrade best practices, specific patterns, or tool usage.
