...
# typescript-advanced-types Workflow

1. **Analyze Request**
   - Understand the user's specific need regarding **typescript-advanced-types**.
   - Identify if the task involves typescript-advanced-types best practices, specific patterns, or tool usage.

2. **Activate Skill**
   - Use the `view_file` tool to read the full instructions in:
     `E:\ABHINAV\AI KIT\.agent\skills\typescript-advanced-types\SKILL.md`
