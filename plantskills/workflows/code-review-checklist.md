---
description: Code review guidelines covering code quality, security, and best practices. allowed-tools: Read, Glob, Grep
---

# code-review-checklist Workflow

1. **Analyze Request**
   - Understand the user's specific need regarding **code-review-checklist**.
   - Identify if the task involves code-review-checklist best practices, specific patterns, or tool usage.

2. **Activate Skill**
   - Use the `view_file` tool to read the full instructions in:
     `E:\ABHINAV\AI KIT\.agent\skills\code-review-checklist\SKILL.md`
