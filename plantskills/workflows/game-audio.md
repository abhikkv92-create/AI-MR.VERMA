---
description: Game audio principles. Sound design, music integration, adaptive audio systems. allowed-tools: Read, Glob, Grep
---

# game-audio Workflow

1. **Analyze Request**
   - Understand the user's specific need regarding **game-audio**.
   - Identify if the task involves game-audio best practices, specific patterns, or tool usage.

2. **Activate Skill**
   - Use the `view_file` tool to read the full instructions in:
     `E:\ABHINAV\AI KIT\.agent\skills\game-audio\SKILL.md`
