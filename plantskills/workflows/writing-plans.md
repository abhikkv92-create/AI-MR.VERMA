...
1. **Analyze Request**
   - Understand the user's specific need regarding **writing-plans**.
   - Identify if the task involves writing-plans best practices, specific patterns, or tool usage.

2. **Activate Skill**
   - Use the `view_file` tool to read the full instructions in:
     `E:\ABHINAV\AI KIT\.agent\skills\writing-plans\SKILL.md`
