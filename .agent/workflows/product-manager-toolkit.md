...
# product-manager-toolkit Workflow

1. **Analyze Request**
   - Understand the user's specific need regarding **product-manager-toolkit**.
   - Identify if the task involves product-manager-toolkit best practices, specific patterns, or tool usage.

2. **Activate Skill**
   - Use the `view_file` tool to read the full instructions in:
     `E:\ABHINAV\AI KIT\.agent\skills\product-manager-toolkit\SKILL.md`
