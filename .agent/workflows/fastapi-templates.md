...
# fastapi-templates Workflow

1. **Analyze Request**
   - Understand the user's specific need regarding **fastapi-templates**.
   - Identify if the task involves fastapi-templates best practices, specific patterns, or tool usage.

2. **Activate Skill**
   - Use the `view_file` tool to read the full instructions in:
     `E:\ABHINAV\AI KIT\.agent\skills\fastapi-templates\SKILL.md`
