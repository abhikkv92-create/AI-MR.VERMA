...
1. **Analyze Request**
   - Understand the user's specific need regarding **vercel-react-best-practices**.
   - Identify if the task involves vercel-react-best-practices best practices, specific patterns, or tool usage.

2. **Activate Skill**
   - Use the `view_file` tool to read the full instructions in:
     `E:\ABHINAV\AI KIT\.agent\skills\vercel-react-best-practices\SKILL.md`
...
- **Related Triggers**: `/frontend-specialist`, `/performance-optimizer`.
