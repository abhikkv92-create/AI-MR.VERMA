...
# senior-fullstack Workflow

1. **Analyze Request**
   - Understand the user's specific need regarding **senior-fullstack**.
   - Identify if the task involves senior-fullstack best practices, specific patterns, or tool usage.

2. **Activate Skill**
   - Use the `view_file` tool to read the full instructions in:
     `E:\ABHINAV\AI KIT\.agent\skills\senior-fullstack\SKILL.md`
