...
# mobile-ios-design Workflow

1. **Analyze Request**
   - Understand the user's specific need regarding **mobile-ios-design**.
   - Identify if the task involves mobile-ios-design best practices, specific patterns, or tool usage.

2. **Activate Skill**
   - Use the `view_file` tool to read the full instructions in:
     `E:\ABHINAV\AI KIT\.agent\skills\mobile-ios-design\SKILL.md`
