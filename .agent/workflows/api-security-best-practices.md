...
# api-security-best-practices Workflow

1. **Analyze Request**
   - Understand the user's specific need regarding **api-security-best-practices**.
   - Identify if the task involves api-security-best-practices best practices, specific patterns, or tool usage.

2. **Activate Skill**
   - Use the `view_file` tool to read the full instructions in:
     `E:\ABHINAV\AI KIT\.agent\skills\api-security-best-practices\SKILL.md`
...
- **Related Triggers**: `/backend-specialist`, `/security-auditor`.
