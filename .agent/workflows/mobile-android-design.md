...
# mobile-android-design Workflow

1. **Analyze Request**
   - Understand the user's specific need regarding **mobile-android-design**.
   - Identify if the task involves mobile-android-design best practices, specific patterns, or tool usage.

2. **Activate Skill**
   - Use the `view_file` tool to read the full instructions in:
     `E:\ABHINAV\AI KIT\.agent\skills\mobile-android-design\SKILL.md`
