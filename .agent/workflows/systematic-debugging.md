...
1. **Analyze Request**
   - Understand the user's specific need regarding **systematic-debugging**.
   - Identify if the task involves systematic-debugging best practices, specific patterns, or tool usage.

2. **Activate Skill**
   - Use the `view_file` tool to read the full instructions in:
     `E:\ABHINAV\AI KIT\.agent\skills\systematic-debugging\SKILL.md`
...
- **Related Triggers**: `/test-engineer`, `/debug`.
