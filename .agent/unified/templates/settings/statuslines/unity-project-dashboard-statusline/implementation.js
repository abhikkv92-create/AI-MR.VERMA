// unity-project-dashboard-statusline Setting Implementation

class UnityProjectDashboardStatuslineSetting {
  constructor(config) {
    this.config = config;
    this.name = 'unity-project-dashboard-statusline';
  }
...
module.exports = UnityProjectDashboardStatuslineSetting;