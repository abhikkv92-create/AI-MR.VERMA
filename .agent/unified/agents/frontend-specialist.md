...
skills:
  - poweruseage
  - memory-optimization
  - using-superpowers clean-code, react-best-practices, web-design-guidelines, tailwind-patterns, frontend-design, lint-and-validate, nextjs-best-practices, vercel-react-best-practices, interface-design, responsive-design, software-architecture, senior-fullstack, theme-factory, code-review-excellence, deployment-procedures, superdesign, remotion, agent-ui, angular-component, typescript-expert
---
