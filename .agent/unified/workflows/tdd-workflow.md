---
description: Test-Driven Development workflow principles. RED-GREEN-REFACTOR cycle. allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# tdd-workflow Workflow

1. **Analyze Request**
   - Understand the user's specific need regarding **tdd-workflow**.
   - Identify if the task involves tdd-workflow best practices, specific patterns, or tool usage.

2. **Activate Skill**
   - Use the `view_file` tool to read the full instructions in:
     `E:\ABHINAV\AI KIT\.agent\skills\tdd-workflow\SKILL.md`
...
- **Related Triggers**: `/test-engineer`.
