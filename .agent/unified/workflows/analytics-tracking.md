...
1. **Analyze Request**
   - Understand the user's specific need regarding **analytics-tracking**.
   - Identify if the task involves analytics-tracking best practices, specific patterns, or tool usage.

2. **Activate Skill**
   - Use the `view_file` tool to read the full instructions in:
     `E:\ABHINAV\AI KIT\.agent\skills\analytics-tracking\SKILL.md`
...
- **Related Triggers**: `/test-engineer`, `/plan`.
