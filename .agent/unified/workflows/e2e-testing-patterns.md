...
# e2e-testing-patterns Workflow

1. **Analyze Request**
   - Understand the user's specific need regarding **e2e-testing-patterns**.
   - Identify if the task involves e2e-testing-patterns best practices, specific patterns, or tool usage.

2. **Activate Skill**
   - Use the `view_file` tool to read the full instructions in:
     `E:\ABHINAV\AI KIT\.agent\skills\e2e-testing-patterns\SKILL.md`
...
- **Related Triggers**: `/frontend-specialist`, `/test-engineer`, `/deploy`, `/debug`.
