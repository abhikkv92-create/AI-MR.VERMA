...
1. **Analyze Request**
   - Understand the user's specific need regarding **code-review-excellence**.
   - Identify if the task involves code-review-excellence best practices, specific patterns, or tool usage.

2. **Activate Skill**
   - Use the `view_file` tool to read the full instructions in:
     `E:\ABHINAV\AI KIT\.agent\skills\code-review-excellence\SKILL.md`
