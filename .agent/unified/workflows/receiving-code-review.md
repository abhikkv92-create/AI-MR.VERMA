...
1. **Analyze Request**
   - Understand the user's specific need regarding **receiving-code-review**.
   - Identify if the task involves receiving-code-review best practices, specific patterns, or tool usage.

2. **Activate Skill**
   - Use the `view_file` tool to read the full instructions in:
     `E:\ABHINAV\AI KIT\.agent\skills\receiving-code-review\SKILL.md`
