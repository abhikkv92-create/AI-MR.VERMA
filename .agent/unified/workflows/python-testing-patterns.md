...
# python-testing-patterns Workflow

1. **Analyze Request**
   - Understand the user's specific need regarding **python-testing-patterns**.
   - Identify if the task involves python-testing-patterns best practices, specific patterns, or tool usage.

2. **Activate Skill**
   - Use the `view_file` tool to read the full instructions in:
     `E:\ABHINAV\AI KIT\.agent\skills\python-testing-patterns\SKILL.md`
