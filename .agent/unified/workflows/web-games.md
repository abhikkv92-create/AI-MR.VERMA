---
description: Web browser game development principles. Framework selection, WebGPU, optimization, PWA. allowed-tools: Read, Write, Edit, Glob, Grep
---

# web-games Workflow

1. **Analyze Request**
   - Understand the user's specific need regarding **web-games**.
   - Identify if the task involves web-games best practices, specific patterns, or tool usage.

2. **Activate Skill**
   - Use the `view_file` tool to read the full instructions in:
     `E:\ABHINAV\AI KIT\.agent\skills\web-games\SKILL.md`
