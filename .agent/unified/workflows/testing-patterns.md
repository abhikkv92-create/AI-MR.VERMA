---
description: Testing patterns and principles. Unit, integration, mocking strategies. allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# testing-patterns Workflow

1. **Analyze Request**
   - Understand the user's specific need regarding **testing-patterns**.
   - Identify if the task involves testing-patterns best practices, specific patterns, or tool usage.

2. **Activate Skill**
   - Use the `view_file` tool to read the full instructions in:
     `E:\ABHINAV\AI KIT\.agent\skills\testing-patterns\SKILL.md`
