---
description: Game art principles. Visual style selection, asset pipeline, animation workflow. allowed-tools: Read, Glob, Grep
---

# game-art Workflow

1. **Analyze Request**
   - Understand the user's specific need regarding **game-art**.
   - Identify if the task involves game-art best practices, specific patterns, or tool usage.

2. **Activate Skill**
   - Use the `view_file` tool to read the full instructions in:
     `E:\ABHINAV\AI KIT\.agent\skills\game-art\SKILL.md`
