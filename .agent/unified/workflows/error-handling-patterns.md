...
# error-handling-patterns Workflow

1. **Analyze Request**
   - Understand the user's specific need regarding **error-handling-patterns**.
   - Identify if the task involves error-handling-patterns best practices, specific patterns, or tool usage.

2. **Activate Skill**
   - Use the `view_file` tool to read the full instructions in:
     `E:\ABHINAV\AI KIT\.agent\skills\error-handling-patterns\SKILL.md`
...
- **Related Triggers**: `/frontend-specialist`, `/backend-specialist`.
