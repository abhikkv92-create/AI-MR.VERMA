---
description: Performance profiling principles. Measurement, analysis, and optimization techniques. allowed-tools: Read, Glob, Grep, Bash
---

# performance-profiling Workflow

1. **Analyze Request**
   - Understand the user's specific need regarding **performance-profiling**.
   - Identify if the task involves performance-profiling best practices, specific patterns, or tool usage.

2. **Activate Skill**
   - Use the `view_file` tool to read the full instructions in:
     `E:\ABHINAV\AI KIT\.agent\skills\performance-profiling\SKILL.md`
...
- **Related Triggers**: `/performance-optimizer`.
