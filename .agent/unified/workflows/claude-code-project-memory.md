...
# claude-code-project-memory Workflow

1. **Analyze Request**
   - Understand the user's specific need regarding **claude-code-project-memory**.
   - Identify if the task involves claude-code-project-memory best practices, specific patterns, or tool usage.

2. **Activate Skill**
   - Use the `view_file` tool to read the full instructions in:
     `E:\ABHINAV\AI KIT\.agent\skills\claude-code-project-memory\SKILL.md`
