---
description: Activate the Orchestrator specialist agent
---
# Trigger: /orchestrator

Use this command to specifically engage the **orchestrator** for tasks within their domain.

1. **Context Analysis**
   - Identify the specific orchestrator requirements in the user request.
   - Cross-reference with `@[agent-skills/orchestrator]` if applicable.
