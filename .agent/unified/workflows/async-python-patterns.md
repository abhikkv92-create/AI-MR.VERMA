...
# async-python-patterns Workflow

1. **Analyze Request**
   - Understand the user's specific need regarding **async-python-patterns**.
   - Identify if the task involves async-python-patterns best practices, specific patterns, or tool usage.

2. **Activate Skill**
   - Use the `view_file` tool to read the full instructions in:
     `E:\ABHINAV\AI KIT\.agent\skills\async-python-patterns\SKILL.md`
...
- **Related Triggers**: `/frontend-specialist`, `/backend-specialist`, `/performance-optimizer`.
