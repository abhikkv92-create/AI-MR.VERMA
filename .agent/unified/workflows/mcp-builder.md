...
1. **Analyze Request**
   - Understand the user's specific need regarding **mcp-builder**.
   - Identify if the task involves mcp-builder best practices, specific patterns, or tool usage.

2. **Activate Skill**
   - Use the `view_file` tool to read the full instructions in:
     `E:\ABHINAV\AI KIT\.agent\skills\mcp-builder\SKILL.md`
