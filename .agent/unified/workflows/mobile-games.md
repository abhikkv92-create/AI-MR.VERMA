---
description: Mobile game development principles. Touch input, battery, performance, app stores. allowed-tools: Read, Write, Edit, Glob, Grep
---

# mobile-games Workflow

1. **Analyze Request**
   - Understand the user's specific need regarding **mobile-games**.
   - Identify if the task involves mobile-games best practices, specific patterns, or tool usage.

2. **Activate Skill**
   - Use the `view_file` tool to read the full instructions in:
     `E:\ABHINAV\AI KIT\.agent\skills\mobile-games\SKILL.md`
...
- **Related Triggers**: `/performance-optimizer`, `/mobile-developer`.
