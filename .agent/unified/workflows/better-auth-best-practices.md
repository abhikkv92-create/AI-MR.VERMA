...
# better-auth-best-practices Workflow

1. **Analyze Request**
   - Understand the user's specific need regarding **better-auth-best-practices**.
   - Identify if the task involves better-auth-best-practices best practices, specific patterns, or tool usage.

2. **Activate Skill**
   - Use the `view_file` tool to read the full instructions in:
     `E:\ABHINAV\AI KIT\.agent\skills\better-auth-best-practices\SKILL.md`
