...
skills:
  - poweruseage
  - memory-optimization
  - using-superpowers clean-code, vulnerability-scanner, red-team-tactics, api-patterns, security-review, api-security-best-practices, better-auth-best-practices, create-auth-skill
---
