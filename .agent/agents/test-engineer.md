...
skills:
  - poweruseage
  - memory-optimization
  - using-superpowers clean-code, testing-patterns, tdd-workflow, webapp-testing, code-review-checklist, lint-and-validate, playwright-skill, e2e-testing-patterns, javascript-testing-patterns, python-testing-patterns, vibe-check-tdd
---
